...
file is true of the thing you end up with.

Point it at a seed for a game of Tetris that runs in the terminal. Once it
works, change the seed and run it again.

You will keep this. The next homework adds behaviour to the factory you
built here.
